...
class MakefileCompletionContributor : CompletionContributor() {
    ...
    init {
        extend(
            CompletionType.BASIC, PlatformPatterns.psiElement(MakefileTypes.IDENTIFIER).andNot(PlatformPatterns.psiElement().inside(PlatformPatterns.psiElement(MakefileTypes.RULE))),
