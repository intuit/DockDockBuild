...
//            dockerFilenameField.text = "dockerfilePath"
    ...
    override fun applyEditorTo(configuration: DockDockBuildRunConfiguration) {
        ...
        configuration.isDockerImage = isDockerImageBox.isSelected
        configuration.isDockerfile = isDockerfileBox.isSelected
    ...
    override fun resetEditorFrom(configuration: DockDockBuildRunConfiguration) {
        ...
        isDockerImageBox.isSelected = configuration.isDockerImage
        isDockerfileBox.isSelected = configuration.isDockerfile
